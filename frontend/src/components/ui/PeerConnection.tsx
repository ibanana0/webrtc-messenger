        ...
        <Card className="backdrop-blur-xl border-white/10">
            ...
            <CardContent className="space-y-2 sm:space-y-3 md:space-y-4 px-2 sm:px-4 pb-2 sm:pb-4">
                {nodeInfo ? (
                    ...
                    <div className="text-xs sm:text-sm text-gray-400 opacity-50">
                ...
                <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <div className="flex gap-1.5 sm:gap-2">
                        <Input
                            ...
                            placeholder="/ip4/.../p2p/..."
                            className="text-[10px] sm:text-xs flex-1 min-w-0 placeholder:opacity-50"
                        />
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="text-[10px] sm:text-xs px-2 sm:px-3 shrink-0"
                        >
                ...
                <div className="space-y-1.5 sm:space-y-2">
                    ...
                    {knownPeers.length > 0 ? (
                        ...
                        <div className="text-[10px] sm:text-xs text-gray-500 italic opacity-50">
                            No peers connected
                        </div>
                    )}
                </div>
